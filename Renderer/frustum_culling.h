...
namespace end
{
	...
	void calculate_frustum(frustum_t& frustum, float4x4& view, points& point);
	//void calculate_frustum(frustum_t& frustum, points& point, float4x4& view, float fov, float ar, float nearDist, float farDist);
